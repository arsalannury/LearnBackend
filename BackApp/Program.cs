...
namespace BackApp
{
    internal class Converter
    {
       ...
       private readonly static string[] options = new string[2] { "1- Remove all letters", "2- Show all letters" };
       private readonly static List<string> letters = new List<string>();
       ...
       static void SettingApplication()
        {
